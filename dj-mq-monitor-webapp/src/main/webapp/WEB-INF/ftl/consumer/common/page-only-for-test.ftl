<#--todo  这个ftl是用来测试的，不能上线。可以先把page.ftl赋值到这个ftl,修改测试通过后，再把这个ftl复制到page.ftl里，--》
<#--todo  注意不要把这两句注释给覆盖掉和copy到page.ftl上 ！！！！！！！！！！！！！！！！！！ -->
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        if(!is_login){//未登录用户加自动授权
            $('body').append('<iframe src="http://apps.weibo.com/djcareer/account/sinac/autologin?d.cb=6" style="display:none;"></iframe>');
        }
    });
</script>
