...
<head>
    ...
    <style>
        ...
        body{
            background:url("http://assets.dajieimg.com/up/404/img/background.png") repeat-x 0 0 ;
        }
        .wrapper {
            width:960px;
            margin:0 auto;
        ...
        .error-500 {
            width:818px;
            height:300px;
            background:url("http://assets.dajieimg.com/up/500/img/500error.png") no-repeat scroll 0 bottom transparent;
            margin:0 auto;
        }
        .content{
...
<div class="wrapper">
    ...
    <div class="cloud">
        <div class="content">
            <div class="text">喵~，这个页面没hold住！</div>
