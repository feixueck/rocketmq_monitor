...
<div class="container theme-showcase" role="main">
    ...
    <div class="container theme-showcase"><!-- /container  -->
        <table class="table table-bordered table-hover">
            ...
            <tbody>
            <#if mqProviders?? && mqProviders.size() gt 0>
                <#list mqProviders as mqProvider>
                    <#if mqProvider??>
                    <tr>
                        <td>${mqProvider.topicName!}</td>
                        <td>${mqProvider.appName!}</td>
                        <td>${mqProvider.pid!}</td>
                        <td>${mqProvider.ip!}</td>
                        <td>${mqProvider.appDesc!}</td>
                    </tr>
                    </#if>
                </#list>
            </#if>
