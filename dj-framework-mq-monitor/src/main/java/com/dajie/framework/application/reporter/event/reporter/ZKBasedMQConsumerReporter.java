 ...
 */
public class ZKBasedMQConsumerReporter extends AbstractZKBasedReporter implements MQApplicationReporter {
    private static final Logger LOGGER = LoggerFactory.getLogger(ZKBasedMQConsumerReporter.class);
